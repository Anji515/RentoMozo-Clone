...
function Home(){
    ...
    const logo=[{'img':`https://i.ibb.co/MkjZFDX/Mobile.jpg`,'title':'Electronics','id':2 ,'path':'productMob'},{'img':`https://i.ibb.co/m44NvHv/Bed.jpg`,'title':'Furniture','id':3, 'path':'productFurn'},{'img':`https://i.ibb.co/rHpqNkL/Zym.jpg`,'title':'Fitness','id':6, 'path':'productFitness'},{'img':`https://i.ibb.co/SwgnFR3/bed1.jpg`,'title':'Appliances','id':1,'path':'productMob'},{'img':`https://i.ibb.co/GC1W8DV/Bike.jpg`,'title':'Bikes','id':4 , 'path':'productMob'},{'img':`https://i.ibb.co/gVp9pTh/WFH.jpg`,'title':'WFH Essentials','id':5, 'path':'productMob'}]

    const moreThing=[{'img':'https://i.ibb.co/wBcnxfD/bed1.jpg','title':'Finest-quality products','desc':"Quality matters to you, and us! That's why we do a strict quality-check for every product."},
    {'img':'https://i.ibb.co/mXPZPCD/location.jpg','title':'Free relocation','desc':"Changing your house or even your city? We'll relocate your rented products for free."},
    {'img':'https://i.ibb.co/y6XqbDp/settings.jpg','title':'Free maintenance','desc':"Keeping your rented products in a spick and span condition is on us, so you can sit back and relax."},
    {'img':' https://i.ibb.co/56pJJwJ/Return.jpg','title':'Cancel anytime','desc':"Pay only for the time you use the product and close your subscription without any hassle."},
    {'img':'https://i.ibb.co/Px0ZPpL/bed2.jpg','title':'Easy return on delivery','desc':"If you don't like the product on delivery, you can return it right away—no questions asked."},{'img':'https://i.ibb.co/3kJRTJN/phones.jpg',
    'title':'Keep upgrading','desc':"Bored of the same product? Upgrade to try another, newer design and enjoy the change!"}]
    ...
    {logo.map((el)=>(
           <Goto to={el.path}>
        <VStack key={el.id} border='1px solid teal' borderRadius={'16px'} boxShadow='rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px' _hover={{boxShadow: 'rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px ', width:'152px'}} padding='10px' width={'150px'} height='120px' cursor='pointer'>
